export default function GeneratingState() {
  return (
    <div className="bg-[#F4F8FC] dark:bg-[#0D1830] border border-dashed border-[var(--c-border)] rounded-xl p-6 space-y-4">
      ...
      <p className="text-xs text-gray-400 dark:text-[#4A6380] text-center">This usually takes 5–10 seconds</p>
    </div>
  );
}
