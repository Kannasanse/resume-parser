...
export default function PdfToExcelPage() {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      const res = await fetch('/api/v1/utilities/pdf/to-excel', { method: 'POST', body: form });
      if (!res.ok) {
  ...
  return (
    ...
    >
      {processing ? (
        <ProcessingState message="Extracting data from PDF…" hint="Reading text content and building your spreadsheet." />
      ) : (
