        ...
        return (
          ...
          >
            ...
            <div
              ...
              className={`flex items-center gap-2.5 px-[18px] py-[11px] select-none transition-colors ${isActive ? 'bg-[#E6F1FB] border-l-2 border-l-[#185FA5] pl-[16px]' : 'bg-ds-card hover:bg-ds-bg/40'}`}
            >
              {/* Grip */}
              ...
              {/* Title */}
              <span
                className={`flex-1 min-w-0 text-[13px] font-semibold truncate cursor-pointer ${!sec.enabled ? 'opacity-40 text-ds-textMuted' : isActive ? 'text-[#185FA5]' : 'text-ds-text'}`}
